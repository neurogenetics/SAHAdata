...
if ("results" %in% slotNames(ann)) {
  if ("marker_based" %in% names(ann@results)) {
    ...
    cat("#### You performed marker-based analysis on this data, using the following parameters: XXXXX")
  }
}
```
...
if ("results" %in% slotNames(ann)) {
  if ("marker_free" %in% names(ann@results)) {
    ...
    cat("#### You performed marker-free analysis on this data, using the following parameters: XXXXX")
  }
}
```
